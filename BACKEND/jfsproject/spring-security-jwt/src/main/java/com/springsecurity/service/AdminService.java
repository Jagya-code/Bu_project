...
//		
//		TicketStore t= resttemplate.getForObject("http://localhost:8041/ticket/ga/fullBookingDetails/{id}", TicketStore.class,id);
//		
//		return t;
//		
//		
...
//
//		Ticket t = resttemplate.getForObject("http://localhost:8041/ticket/get/{emailId}", Ticket.class, emailId);
//
//		return t;
//
//	}
