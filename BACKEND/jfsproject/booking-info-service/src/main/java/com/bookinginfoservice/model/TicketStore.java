...
public class TicketStore {
	...
	public TicketStore(String id, String train_name, String train_no, String fname, String lname, int age,
			String start_from, String destination, String coach_no, int seat_no,String emailId) {
		super();
		this.id = id;
	...
	public String toString() {
		return "TicketStore [id=" + id + ", train_name=" + train_name + ", train_no=" + train_no + ", fname=" + fname
				...
				+ ", coach_no=" + coach_no + ", seat_no=" + seat_no + ", emailId=" + emailId + "]";
	}
